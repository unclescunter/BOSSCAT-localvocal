...
echo "  ROCm requires HSA_OVERRIDE_GFX_VERSION=10.3.0 to be set in your"
echo "  environment so whisper.cpp can use the GPU for inference."
echo "  Set it permanently in your shell profile or /etc/environment:"
echo "    echo 'export HSA_OVERRIDE_GFX_VERSION=10.3.0' >> ~/.bashrc"
echo "    source ~/.bashrc"
echo ""
